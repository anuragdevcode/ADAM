...
const EXAMPLE_CARDS = [
  ...
  {
    title: 'MGNREGA Wage Rates Revision Order',
    dept: 'Rural Development',
    query:
      'What are the notified wage rates for MGNREGA workers under the Rural Development Department order 2024?',
    icon: Mail,
  },
  {
    title: 'Child Care Leave (CCL) Rules for Women',
    dept: 'General Administration',
    query:
      'What are the eligibility criteria and maximum entitlement for Child Care Leave for female government servants in Uttarakhand?',
    icon: MessageSquare,
  },
  {
    title: 'Online Land Mutation & Khasra Verification',
    dept: 'Board of Revenue',
    query:
      'What are the statutory guidelines and timeline for online land mutation under the Board of Revenue circular 2023?',
    icon: Code,
  },
];
                ...
                {msg.role === 'user' ? (
                  ...
                  <div className="w-full max-w-3xl bg-white rounded-2xl border border-[#eaecf0] p-5 shadow-[0_2px_8px_rgba(16,24,40,0.04)]">
                    ...
                    <div className="text-sm text-gray-800 leading-relaxed whitespace-pre-wrap">
                      {msg.content}
                      {msg.isStreaming && (
                        <span className="inline-block w-1.5 h-4 ml-1 bg-purple-600 animate-pulse rounded-full" />
                      )}
                    </div>
