                    ...
                    <div className="w-full bg-surface rounded-panel border border-line p-5 shadow-sm">
                      <div className="flex items-center gap-2 mb-3 pb-3 border-b border-line">
                        ...
                        <span className="ml-auto flex items-center gap-1.5 min-w-0">
                          {msg.modelId && (
                            <span
                              className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full bg-surface-subtle border border-line text-ink-muted text-[10px] font-medium min-w-0"
                              title={`Answered by ${msg.modelId}`}
                            >
                              ...
                              <span className="max-w-[160px] truncate">{msg.modelId}</span>
                            </span>
                          )}
                          {msg.isNoAnswer && (
                            <span className="px-2 py-0.5 rounded-full bg-warn-soft text-warn text-[10px] font-semibold uppercase tracking-wide shrink-0">
                              No answer in corpus
                            </span>
                          )}
                        </span>
